...
function setFooter() {
  ...
  footer.innerHTML += "<div class='footerCenter' id='footerCenter'><ul> <li><a href=\"/contact/index.html\">Contact</a> <br></li> <li><a href=\"/\">Home</a><br></li><li><label for='logoutButton' hidden>Button to logout of account.</label><input id='logoutButton' type='button' value='LogOut' onclick='logOut()'></li><ul></div>";
  footer.innerHTML +=
